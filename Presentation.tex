...
\begin{frame}{Pillar 3: Digital Twin}
  \begin{block}{Definition}
    Digital twins are virtual replicas of physical systems that enable development, simulation, analysis, testing, and validation without impacting production environments. Digital twins maintain synchronization with their physical counterparts and may utilize ``hardware in the loop'' of physical components
  \end{block}
...
\begin{frame}{Pilot Testing and Instrument Refinement}
  ...
  \begin{block}{Empirical Contributions to Instrument Design}
    \begin{itemize}
      ...
      \item Section ordering adjusted
