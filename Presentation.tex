...
% SLIDE 3: About Me
\begin{frame}[allowframebreaks]{/whois John Bonar}
  \begin{itemize}
    \item Seven Degrees and Certificates from Dakota State University
    \item Senior Manager Solution Engineering \& Architecture, Program Work Environments, Digital Technology at Collins Aerospace (RTX)
    \item Daily experience with high-compliance environments: DAAG, JSIG, CNSS, CSFC, CDS
    \item Research Focus: Systems Engineering for IT and Information Assurance
    \item First Computer: Commodore 64K
    \item First computer job: 1994 CCS Computers Burlington, Iowa
    \item Is legally Darth Vader
    \item Come See My Session at Dakotacon 2026: ``Red \& Blue SysML: Model Based Systems Engineering for Cyber Operations \& Defense''
  \end{itemize}

  \begin{block}{About This Presentation}
    I have no financial interest in any of the tools, products, or companies mentioned in this presentation. I have no conflicts of interest to disclose.

    The presentation slides will be covered briefly and quickly, this presentation is available on my github repository and I encourage you to review the slides in detail at your leisure. The presentation is designed to be comprehensive and self-contained, so it can be reviewed independently of the live presentation.

    This Presentation has a significant amount of technical content that will be displayed, but I will be happy to provide additional details on any topic during the Q\&A session or afterwards outside the presentation.
  \end{block}
\end{frame}
...
\begin{frame}{Presentation Agenda}
  \begin{enumerate}
    \item Problem Statement: The Visibility Crisis
    \item Research Questions
    \item Identified Research Gap
    \item Digital Engineering: Four Pillars
    \item Literature Review: Four Interrelated Arguments
    \item Research Gaps Summary
    \item Research Design Overview
    \item Survey Instrument Structure
    \item Research Timeline
    \item Proposal Summary
  \end{enumerate}
\end{frame}

%% ============================================================
%% MAIN CONTENT SLIDES (10)
%% ============================================================

% SLIDE 6: Opening Scenario
\section{Problem Statement}
\begin{frame}[allowframebreaks]{The Visibility Crisis: A Real-World Scenario}
...
\begin{frame}[allowframebreaks]{Identified Research Gap}
  ...
  \vspace{0.2cm}
  \textbf{Gap Validated:} Wooley \& Womack (2025) systematic literature review of Digital Engineering adoption, benefits, and challenges explicitly noted the absence of research addressing enterprise IT or Information Assurance applications.
...
% SLIDE 9: Digital Engineering Introduction
\section{Digital Engineering Foundations}
\begin{frame}[allowframebreaks]{Digital Engineering: Four Pillars}
  \begin{center}
  ...
  \begin{columns}
    ...
    \begin{block}{Digital Twin}
      Pseudo Virtual replicas for development, evaluation, testing, and validation
    \end{block}
...
% SLIDE 10: Literature Review - Analytical Narrative
\section{Literature Review}
\begin{frame}[allowframebreaks]{Literature Review: Four Interrelated Arguments}
  \begin{small}
    Chapter 2 examines the research landscape through an analytical synthesis organized around four interrelated arguments:

    \vspace{0.3cm}
    \begin{block}{Argument 1: Disciplinary Silos}
    ...
    \begin{block}{Argument 2: The Evidence Paradox}
    ...
    \begin{block}{Argument 3: Perceptions Drive Adoption}
    ...
    \begin{block}{Argument 4: Unfulfilled Requirements}
...
% SLIDE 11: Research Gaps Summary
\begin{frame}[allowframebreaks]{Literature Review: Research Gaps Summary}
  \begin{table}[H]
    \begin{scriptsize}
      \begin{tabular}{@{}p{1.1in}p{1.5in}p{1.5in}@{}}
        \toprule
        \textbf{Domain} & \textbf{Gap} & \textbf{Implication} \\
        \midrule
        ...
        Professional Perceptions & Unknown awareness among IT/IA professionals & \textbf{This research addresses} \\
        \bottomrule
      \end{tabular}
    \end{scriptsize}
  \end{table}
...
% SLIDE 12: Research Design Overview
...
% SLIDE 13: Survey Instrument Structure
...
% BACKUP: Current State Overview
\begin{frame}[allowframebreaks]{Current State of Information System Management}
...
% BACKUP: Information Assurance Practice Challenges
\begin{frame}[allowframebreaks]{Information Assurance Practice Challenges}
  \begin{block}{Key Frameworks}
    NIST SP 800-37 Rev 2: Risk Management Framework \\ ISO 31000: Risk Management \\ISO 27001: Information Security Management \\ NIST Cybersecurity Framework 2.0
  \end{block}
  ...
  \textbf{Context of This Dissertation:} This dissertation proposal utilizes a contextual viewpoint that is aligned to NIST Special Publication 800-37 Revision 2: Risk Management Framework, NIST SP 800-53 Revision 5, CNSSI 1253, \& DCSA Assessment and Authorization Guide. The existing gaps and challenges are applicable to all compliance frameworks that demand documentation accuracy and traceability.
\end{frame}

% BACKUP: Expanding Compliance Landscape
\begin{frame}[allowframebreaks]{The Expanding Compliance Landscape}
  \begin{block}{NIST Cybersecurity Framework 2.0 (February 2024)}
  ...
  \begin{block}{SP 800-171 Revision 3}
    Protects Controlled Unclassified Information in nonfederal systems. Restructured from fourteen to seventeen security control families, 97 control requirements, 422 individual control assessment objectives and 49 Organization-Defined Parameters.
  \end{block}

  \vspace{1.0cm}

  \begin{block}{SP 800-172 Revision 3}
    One hundred and two enhanced requirements that build upon SP~800-171 controls. Focus on advanced persistent threats and sophisticated adversaries. Emphasizes enhanced proactive defense, continuous monitoring, centralized inventory \& component management, Implementation of Software Bill of Materials (SBOM) \& Hardware Bill of Materials (HBOM), component validation, cybersecurity supply chain risk management, secure software development, firmware management and verification, active cyber defensive practices, resilience, and rapid incident response capabilities.
  \end{block}
  ...
  \vspace{0.2cm}
  \textbf{Key Insight:} Escalating documentation, traceability, and verification demands that Digital Engineering capabilities are designed to address.
\end{frame}

% BACKUP: IT Service Management Challenges
\begin{frame}[allowframebreaks]{IT Service Management Practice Challenges}
...
% BACKUP: Industry Statistics - Visibility Gaps
\begin{frame}[allowframebreaks]{Evidence: Visibility and Documentation Failures}
  \begin{table}[H]
    \begin{scriptsize}
      \begin{tabular}{@{}lll@{}}
        \toprule
...
% BACKUP: Industry Statistics - Security Impact
\begin{frame}[allowframebreaks]{Evidence: Security Impact Metrics}
  \begin{table}[H]
    \begin{scriptsize}
      \begin{tabular}{@{}lll@{}}
        \toprule
...
% BACKUP: Documentation Gap Reality
\begin{frame}[allowframebreaks]{The Documentation-Reality Gap}
...
\begin{frame}[allowframebreaks]{Pillar 1: Model-Based Systems Engineering}
  \begin{small}
    \begin{block}{Definition}
      MBSE shifts from document-centric to model-centric approaches. Models become the authoritative representation of system architecture, requirements, behavior, design, configuration, and interfaces using SysML/UML modeling languages.
    \end{block}
    \vspace{1.0cm}
    \textbf{Standards and Tools:}
    \begin{itemize}
      \item SysML v1 \(\rightarrow\) v2 evolution with textual notation and API standardization
      \item Commercial: 3DS Cameo, IBM Rhapsody, Sparx Enterprise Architect
...
% BACKUP: Enterprise Architecture Framework
...
% BACKUP: Disciplinary Silos
\begin{frame}[allowframebreaks]{Literature Review: Independent Disciplinary Evolution}
  \begin{block}{Parallel Paths}
  ...
  \begin{block}{Key Evidence}
    \begin{itemize}
      \item Systems engineering emerged from defense laboratories (Hossain 2020; Honour 2018)
      \item Information assurance grew from national security policy and computing education (Maconachy 2001; Dark 2006)
      \item Cybersecurity crystallized as a ``meta-discipline'' (Parrish 2018; CSEC 2017)
      \item ITSM developed as a practitioner-driven domain with limited academic theorization (Iden 2013; MacLean 2023)
    \end{itemize}
  \end{block}

  \vspace{0.2cm}
  \textbf{Consequence:} No intellectual infrastructure exists to facilitate cross-disciplinary methodological exchange. Researchers publish in different journals, cite different theorists, and frame problems through different conceptual lenses.
\end{frame}

% BACKUP: Evidence Paradox
\begin{frame}[allowframebreaks]{Literature Review: The Evidence Paradox}
  \begin{block}{Perceived vs. Measured Value (Henderson \& Salado 2021)}
  ...
  \begin{block}{Measurement Deficit}
    \begin{itemize}
      \item Rogers \& Mitchell (2021) remains one of only two papers reporting measured MBSE ROI
      \item Henderson (2023) developed measurement framework---deficit unresolved
      \item Campo (2023) confirmed persistent gap between beliefs and published evidence
      \item Wooley \& Womack (2025) confirmed absence of enterprise IT/IA research
    \end{itemize}
  \end{block}

  \vspace{0.2cm}
  \textbf{Implication:} Organizations outside systems engineering lack experiential evidence to validate MBSE investment---creating rational hesitation that perception data can help inform.
\end{frame}

% BACKUP: Adoption Barriers Evidence
\begin{frame}[allowframebreaks]{Literature Review: Perceptions Drive Adoption}
  ...
  \begin{block}{Parallel Cybersecurity Adoption Research}
...
% BACKUP: Compliance Imperative
\begin{frame}[allowframebreaks]{Literature Review: The Compliance Imperative}
  \begin{block}{Frameworks Require What Practices Cannot Deliver}
    SP~800-53 Rev 5 mandates controls requiring enterprise architecture capabilities: PL-2 (security plans), PL-8 (security architecture), PM-7 (enterprise architecture), CM-2 (baselines), CM-8 (component inventory), and SA-17 (design specifications). Each demands documentation accuracy that organizations demonstrably lack when implementing these controls within their systems that provide real-time or near real-time visibility, traceability, and accuracy.
  \end{block}

  \vspace{1.5cm}

  \begin{block}{Emerging Compliance Automation}
    \begin{itemize}
      \item Santilli (2023): Defined continuous compliance with 13 requirements
      \item Angermeir (2024): Design science for continuous security compliance
      \item NIST OSCAL: Machine-readable compliance formats---aligns with DE emphasis on machine-readable documentation
    \end{itemize}
  \end{block}

  \vspace{2.0cm}

  \begin{block}{Parallel Tracks Without Convergence}
...
% BACKUP: Digital Twins as Emerging Security Tools
\begin{frame}[allowframebreaks]{Literature Review: Digital Twins for Security}
  \begin{block}{Maturing Research Area}
    Multiple systematic reviews confirm sufficient research volume to warrant meta-analysis: Alcaraz \& L\'{o}pez (2022, 300+ citations), El Hajj (2024, 67 papers), Alhumam (2025), Jeremiah (2024), Qureshi (2025).
  \end{block}

  \begin{block}{Security Applications}
    \begin{itemize}
      \item SOC analyst training through digital twin-based cyber ranges (Vielberth 2021)
      \item Enterprise security posture management (Dietz \& Pernul 2020)
      \item Threat modeling across cyber-physical system lifecycles (Erceylan 2025)
      \item Incident detection and response for critical infrastructure (Kampourakis 2025)
    \end{itemize}
  \end{block}

  \begin{block}{Disconnected from Digital Engineering}
...
% BACKUP: Cross-Disciplinary Transfer
...
% BACKUP: Methodology Justification
...
\begin{frame}[allowframebreaks]{Sample Size Determination}
  ...
  \begin{block}{Target Sample}
    \begin{itemize}
      ...
      \item Requires distribution to approximately 1,500--2,000 professionals
    \end{itemize}
  \end{block}
\end{frame}

% BACKUP: Question Formats
...
% BACKUP: Likert Scale Analytical Treatment
...
% BACKUP: Research Question Mapping
...
% BACKUP: Data Analysis - Descriptive
...
% BACKUP: Data Analysis - Inferential
...
% BACKUP: Validity and Reliability
...
% BACKUP: Response Bias Mitigation
...
% BACKUP: Expected Contributions - Academic
...
% BACKUP: Expected Contributions - Industry
...
% BACKUP: Expected Contributions - Commonwealth and Society
