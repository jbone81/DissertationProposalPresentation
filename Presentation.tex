...
\begin{frame}{Check In Code}
  \begin{center}
    \includegraphics[width=6cm]{CheckInCode.png}
  \end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{/whois John Bonar}
  \begin{itemize}
    ...
    \item Senior Manager Solution Engineering \& Architecture, Program Work Environments, Digital Technology at Collins Aerospace (part of RTX)
...
\begin{frame}{About This Presentation}
  ...
  \begin{block}{Disclaimer}
    The naming of specific tools do not constitute endorsement by the author or their employer.

    \vspace{0.3cm}

    The views and opinions expressed in this presentation are my own and do not necessarily reflect the official policy or position of any agency, department, organization, employer, or institution.

  \end{block}
  \begin{block}{Additional Information}
    There are a lot of backup slides in the presentation, if you are interested in more details on these subjects, there is a link to the github repository for this proposal defense presentation.
  \end{block}
\end{frame}
