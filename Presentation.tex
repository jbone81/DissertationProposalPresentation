...
\begin{frame}{/whois John Bonar}
  \begin{itemize}
    ...
    \item Caught a 30 day ``ban'' from DoE Ames Lab at age 15 for locking up a Cray YMP2E with a massive ray tracing simulation
...
\begin{frame}[allowframebreaks]{Information Assurance Practice Challenges}
  \begin{block}{Key Frameworks}
    NIST SP 800-37 Rev 2: Risk Management Framework \\ ISO 31000: Risk Management \\ NIST Cybersecurity Framework 2.0
  \end{block}
  ...
  \vspace{0.2cm}
  \textbf{Context of This Presentation:} This presentation and dissertation proposal focuses on contextual dialog that aligns to NIST Special Publication 800-37 Revision 2: Risk Management Framework. The existing gaps and challenges apply equally to all compliance frameworks that demand documentation accuracy and traceability.
\end{frame}
...
\begin{frame}[allowframebreaks]{The Expanding Compliance Landscape}
  ...
  \begin{block}{SP 800-172 Revision 3}
    One hundred and two enhanced requirements that build upon SP~800-171 controls. Focus on advanced persistent threats and sophisticated adversaries. Emphasizes proactive defense, continuous monitoring, centralized inventory \& component management, Implementation of Software Bill of Materials (SBOM) \& Hardware Bill of Materials (HBM), component validation, cybersecurity supply chain risk management, secure software development, firmware management and verification, active cyber defensive practices, resilience, and rapid incident response capabilities.
  \end{block}
